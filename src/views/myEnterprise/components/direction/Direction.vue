          ...
          <q-card style="max-height: 260px">
            <div class="row" style="gap: 5px">
              ...
              <div
                ...
                v-if="newStore.phones && newStore.phones[0].type !== 'TEL'"
              >
                <q-icon
...
import directionController from "@/views/myEnterprise/components/direction/direction";
...
import PhoneModal from "@/views/myEnterprise/components/direction/components/PhoneModal.vue";
import SingleStoreInformation
  from "@/views/myEnterprise/components/direction/components/SingleStoreInformation.vue";
