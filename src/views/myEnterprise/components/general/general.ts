...
import MyEnterpriseService from "@/views/myEnterprise/services/MyEnterpriseService";
...
export class GeneralSettings {
  ...
  private m_clientQuestions: Array<IClientQuestions> | undefined = undefined;

  private myEnterpriseService: MyEnterpriseService = new MyEnterpriseService();
   ...
   */
  public get clientQuestions(): Array<IClientQuestions> {
    return this.m_clientQuestions!;
  }
   ...
   */
  public set clientQuestions(value: Array<IClientQuestions>) {
    this.m_clientQuestions = value;
  }
  ...
  async loadInfo() {
    ...
    this.loadOptions();
    this.m_clientQuestions = await (
      await this.myEnterpriseService.getClientQuestions()
    ).data;
    //TODO: CHECK THIS
