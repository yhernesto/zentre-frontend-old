...
import type {ISchedule} from "@/views/myEnterprise/components/schedule/models/ISchedule";
import HourRange  from "@/views/myEnterprise/components/schedule/components/daySchedule/component/HoursRange.vue";
